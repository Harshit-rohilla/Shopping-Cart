...
function Item({obj}){
    ...
    return(
        <>
        <div className="h-80 lg:w-[23.5%] md:w-[30%] w-full py-2 px-3 group rounded-lg shadow-[0_0_10px_rgba(0,0,0,0.3)] lg:hover:scale-110 transition-transform duration-300 flex flex-col gap-y-4 items-center">
